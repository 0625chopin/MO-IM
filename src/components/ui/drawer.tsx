...
function Drawer({
  ...
  // shadcn 원본은 이 컨텍스트 값을 `useMemo`로 감쌌지만, 측정 근거 없는 수동 메모이제이션은
  // D-029 위반이다 — React Compiler가 컴포넌트 자체를 메모이즈하므로 매 렌더 재생성으로 되돌렸다.
  const contextValue: DrawerContextProps = { hasSnapPoints, modal, showSwipeHandle, swipeDirection }
